...
export const updateAppTitleInDB = (title) => {
  return new Promise((resolve, reject) => {
    const query = "UPDATE AppName SET title = ? WHERE id = 1";
...
export const getAppTitleFromDB = () => {
  return new Promise((resolve, reject) => {
    const query = "SELECT title FROM AppName WHERE id = 1";
